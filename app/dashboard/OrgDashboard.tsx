 ...
 * Dashboard view specifically for organizations (profile.kind === "org")
 */
...
export function OrgDashboard({ user }: OrgDashboardProps) {
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground text-lg">
              Manage your organization, post jobs, and connect with crew members
            </p>
          </div>
            ...
            <main className="lg:col-span-3">
                            ...
                            <div className="flex items-center gap-3">
                              <div
                                className={`p-2 rounded-lg ${
                                  userOrganization.logo_url ? "bg-green-100" : "bg-gray-100"
                                }`}
                              >
                                <Building2
                                  className={`h-5 w-5 ${
                                    userOrganization.logo_url ? "text-green-600" : "text-gray-400"
                                  }`}
                                />
                              </div>
                              <div>
                                ...
                                <p className="text-xs text-muted-foreground">
                                  {userOrganization.logo_url ? "Uploaded" : "Not set"}
                                </p>
                              </div>
                            </div>
                          </div>
              ...
              {activeTab === "crew" && (
                <div className="space-y-6">
                  ...
                  <Card className="p-12 text-center bg-white border-2 border-border">
                    <div className="text-6xl mb-4">👥</div>
                    <h3 className="text-2xl font-bold mb-2">No saved crew members yet</h3>
                    <p className="text-muted-foreground mb-6 text-lg">
                      Save crew profiles you&apos;re interested in to easily contact them later
                    </p>
                    <Link href="/crew">
                      <Button size="lg">Browse Available Crew</Button>
                    </Link>
                  </Card>
                </div>
              )}
