...
function DashboardContent() {
  ...
  const isOrganization = user.kind === "org";
  ...
  const handleCreateOrganization = async () => {
    ...
    try {
      ...
      const orgName = user.display_name || "My Organization";
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          ...
                          <div className="p-4 bg-cream-50 rounded-lg border-2 border-border">
                            <div className="flex items-center gap-3">
                              <div
                                className={`p-2 rounded-lg ${
                                  userOrganization.gallery_images?.length > 0 ? "bg-green-100" : "bg-gray-100"
                                }`}
                              >
                                <ImageIcon
                                  className={`h-5 w-5 ${
                                    userOrganization.gallery_images?.length > 0
                                      ? "text-green-600"
                                      : "text-gray-400"
                                  }`}
                                />
                          ...
                          <div className="p-4 bg-cream-50 rounded-lg border-2 border-border">
                            <div className="flex items-center gap-3">
                              <div
                                className={`p-2 rounded-lg ${
                                  userOrganization.video_urls?.length > 0 ? "bg-green-100" : "bg-gray-100"
                                }`}
                              >
                                <Video
                                  className={`h-5 w-5 ${
                                    userOrganization.video_urls?.length > 0
                                      ? "text-green-600"
                                      : "text-gray-400"
                                  }`}
                                />
                        ...
                        <div className="flex-1 space-y-3">
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              {user.kind === "person" ? "Individual" : "Organization"} • {user.country || "Location not set"}
                            </p>
                          </div>
                          {user.bio && (
